package com.ge.controller.base;

import com.ge.common.DataResult;
import com.ge.common.ExecStatus;
import com.ge.common.exception.BaseException;
import com.ge.common.exception.RepeatedSubmitFormException;
import com.ge.common.exception.ValidateException;
...
import static com.ge.common.Constant.*;
...
public class ExceptionAdvice {
    ...
    /**
     * spring validator实体对象参数校验结果处理<br>
     * 数据绑定验证失败异常（如需要数字却填的字母）
     * @param ex
     * @return
     */
    ...
    public ResponseEntity<DataResult> handleConstraintViolationException(ConstraintViolationException ex,
                                                                    HttpServletRequest request,
                                                                    HttpServletResponse response) {
    	//将错误信息提取到ValidateException中，利用统一的方式处理
