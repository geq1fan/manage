...
import com.ge.common.security.xss.XssHttpServletRequestWrapper;
...
/**
 * 权限Controller Created by cuiP on 2017/2/8.
 */
@Controller
...
public class PermissionController extends BaseController {
	...
	@GetMapping()
	public String list(String permissionName, ModelMap modelMap) {
		
		if (StrUtil.isEmpty(permissionName)) {
			List<Permission> list = permissionService.findAll();
			modelMap.put("list", list);
		} else {
			List<Permission> list = permissionService.findSimilarByName(permissionName);
			modelMap.put("list", list);
		}
	...
	@CacheEvict(value = "menuListCache", allEntries = true) // 清空缓存
